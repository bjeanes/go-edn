...
var yyAct = []int{
	...
	2, 14, 28, 17, 18, 19, 20, 21, 15, 17,
	18, 19, 20, 21, 26, 25, 16, 29, 13, 17,
	18, 19, 20, 21, 25, 27, 30, 9, 22, 8,
	24, 12, 23, 11, 10, 7, 6, 5, 4, 3,
	1,
}
var yyPact = []int{

	23, -1000, -1000, -1000, -1000, -1000, -1000, -1000, -9, -9,
	-1000, 24, 21, 7, -1000, -1000, -9, -1000, -1000, -1000,
	-1000, -1000, -3, 8, -1000, 23, -1000, -1000, -1000, -1000,
	-1000,
}
var yyPgo = []int{

	0, 40, 0, 39, 38, 37, 36, 35, 16, 8,
	1, 18,
}
var yyR1 = []int{
...
yydefault:
	...
	case 22:
		//line parser.y:82
		{ yyVAL.v = Value(Sequence(Vector{}).Into(Sequence(yyS[yypt-1].v.(*List)))) }
	}
